...
import logo from "../../img/next logo.png";
  ...
  const performFetch = async () => {
    ...
    try {
      ...
      if (response.data && response.data.notifications) {
        ...
        console.log(
          `Fetched ${response.data.notifications.length} notifications, ${unread} unread`
        );
      } else {
      ...
      if (
        error.response &&
        error.response.data &&
        error.response.data.message === "Session expired or replaced"
      ) {
  ...
  const getNotificationIcon = (notification) => {
    switch (notification.type) {
      ...
      case "social_reaction":
        ...
        if (notification.social_reaction_type === "support")
  ...
  return (
    <>
      ...
      >
        ...
        <Flex h="full" alignItems="center" justifyContent="space-between" maxW="container.xl" mx="auto">
          <Link to={user ? `/home` : "/"}>
            <Box display="flex" alignItems="center" _hover={{ opacity: 0.9 }}>
              <img src={logo} alt="Next Edu School" style={{ height: "52px", width: "auto" }} />
            </Box>
          </Link>
