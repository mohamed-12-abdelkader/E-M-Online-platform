...
const TeacherInfo = ({ teacher, number }) => (
  <div className='teacherinfo bg-gray-400 h-auto  mx-auto px-4 mt-[80px] mb-[80px]   py-8 md:flex h-[350px] md:justify-between items-center rounded-lg shadow-lg'>
    {/* الجزء الأول: صورة المدرس */}
    <div className='  w-[95%] relative  md:w-1/2 flex justify-center items-center  mb-6 md:mb-0'>
      <Zoom>
        <img
          src={teacher.image}
          alt={`${teacher.name}`}
          className='rounded-lg shadow-lg  my-auto h-[300px] mx-4 w-[300px] object-cover'
